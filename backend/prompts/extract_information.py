...
- "keywords" should be a **short list (5–8 terms)**, including only important related words from the notes or commonly associated with the concept. 
- Do not generate long phrases; use only single words or very short terms.
- Include synonyms and related subtopics when appropriate, but keep them factual.
  ...
  "nodes": [
    {
      ...
      "keywords": "List of words found in the notes and general topic knowledge that describe or are closely related to this topic" 
    }
  ]
}
"""
